 ...
 */
public class MyTextViewbigr extends android.support.v7.widget.AppCompatTextView {

    public MyTextViewbigr(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public MyTextViewbigr(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    ...
    public MyTextViewbigr(Context context)
    {
        super(context);
        init(null);
    }
